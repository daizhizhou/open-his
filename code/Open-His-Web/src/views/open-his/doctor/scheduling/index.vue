  ...
  <div class="app-container">
    ...
    >
      <el-table :data="editData" border>
        <el-table-column prop="subsectionType" label="时间/日期" align="center" :formatter="subsectionTypeFormatter" />
        <el-table-column prop="schedulingTypeList[0]" :label="labelNames[0]" align="center">
          <template slot-scope="scope">
            <el-select
              v-model="scope.row.schedulingTypeList[0]"
              clearable
              size="small"
            >
              <el-option
        ...
        <el-table-column prop="schedulingTypeList[1]" :label="labelNames[0]" align="center">
          <template slot-scope="scope">
            <el-select
              v-model="scope.row.schedulingTypeList[1]"
              clearable
              size="small"
            >
              <el-option
        ...
        <el-table-column prop="schedulingTypeList[2]" :label="labelNames[0]" align="center">
          <template slot-scope="scope">
            <el-select
              v-model="scope.row.schedulingTypeList[2]"
              clearable
              size="small"
            >
              <el-option
        ...
        <el-table-column prop="schedulingTypeList[3]" :label="labelNames[0]" align="center">
          <template slot-scope="scope">
            <el-select
              v-model="scope.row.schedulingTypeList[3]"
              clearable
              size="small"
            >
              <el-option
        ...
        <el-table-column prop="schedulingTypeList[4]" :label="labelNames[0]" align="center">
          <template slot-scope="scope">
            <el-select
              v-model="scope.row.schedulingTypeList[4]"
              clearable
              size="small"
            >
              <el-option
        ...
        <el-table-column prop="schedulingTypeList[5]" :label="labelNames[0]" align="center">
          <template slot-scope="scope">
            <el-select
              v-model="scope.row.schedulingTypeList[5]"
              clearable
              size="small"
            >
              <el-option
        ...
        <el-table-column prop="schedulingTypeList[6]" :label="labelNames[0]" align="center">
          <template slot-scope="scope">
            <el-select
              v-model="scope.row.schedulingTypeList[6]"
              clearable
              size="small"
            >
              <el-option
...
export default {
  ...
  methods: {
    ...
    schedulingTypeDay1Formatter(row) {
      return this.selectDictLabel(this.schedulingTypeOptions, row.schedulingTypeList[0])
    },
    // 翻译周一排班类型
    schedulingTypeDay2Formatter(row) {
      return this.selectDictLabel(this.schedulingTypeOptions, row.schedulingTypeList[1])
    },
    // 翻译周二排班类型
    schedulingTypeDay3Formatter(row) {
      return this.selectDictLabel(this.schedulingTypeOptions, row.schedulingTypeList[2])
    },
    // 翻译周三排班类型
    schedulingTypeDay4Formatter(row) {
      return this.selectDictLabel(this.schedulingTypeOptions, row.schedulingTypeList[3])
    },
    // 翻译周四排班类型
    schedulingTypeDay5Formatter(row) {
      return this.selectDictLabel(this.schedulingTypeOptions, row.schedulingTypeList[4])
    },
    // 翻译周五排班类型
    schedulingTypeDay6Formatter(row) {
      return this.selectDictLabel(this.schedulingTypeOptions, row.schedulingTypeList[5])
    },
    // 翻译周六排班类型
    schedulingTypeDay7Formatter(row) {
      return this.selectDictLabel(this.schedulingTypeOptions, row.schedulingTypeList[6])
    },
    // 合并的代码
    ...
    handleSubmit() {
      const form = {
        beginDate: this.schedulingData.startTimeThisWeek,
        data: this.editData
      }
      this.loading = true
      // 保存
