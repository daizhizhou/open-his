...
export const asyncRoutes = [
  {
    ...
    children: [
      {
        path: 'dept',
        component: () => import('@/views/open-his/system/department/index'),
        name: '/system/dept',
        meta: {
          title: '科室管理',
          icon: 'edit'
      ...
      {
        path: 'role',
        component: () => import('@/views/open-his/system/role/index'),
        name: '/system/role',
        meta: {
          title: '角色管理',
          icon: 'tab'
      ...
      {
        path: 'notice',
        component: () => import('@/views/open-his/system/notice/index'),
        name: '/system/notice',
        meta: {
          title: '通知公告',
          icon: 'theme'
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: 'medicinal',
        component: () => import('@/views/open-his/erp/medicines/index'),
        name: '/stock/medicinal',
        meta: { title: '药品信息维护', icon: 'list' }
      },
      {
        path: 'provider',
        component: () => import('@/views/open-his/erp/provider/index'),
        name: '/stock/provider',
  ...
  },
  {
    ...
    children: [
      {
        path: 'docheck',
        component: () => import('@/views/open-his/doctor/checkResult/newcheck'),
        name: '/check/docheck',
        meta: { title: '新开检查', icon: 'list' }
      },
      {
        path: 'checkresult',
        component: () => import('@/views/open-his/doctor/checkResult/checking'),
...
export const lastRoute = [
  ...
  },
  {
    ...
    children: [
      {
        path: 'newPurchase',
        component: () => import('@/views/open-his/erp/purchase/newPurchase'),
        name: '/erp/purchase/newPurchase',
        meta: { title: '采购入库', icon: 'list' }
      },
      {
        path: 'editPurchase/:purchaseId',
        component: () => import('@/views/open-his/erp/purchase/editPurchase'),
